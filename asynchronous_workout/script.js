...
// // // getCountryAndNe ighbour('poland');
// // // getCountryAndNeighbour('usa');

// // //callback hell example with setTimeout
...
// // //       if (!response.ok) throw new Error(`Country now found ${response.status}`);
// // //       return response.json();
// // //     })
// // //     .then(data => {
// // //       renderCountry(data[0]);
